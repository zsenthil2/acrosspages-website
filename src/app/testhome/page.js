...
import AnimatedH1 from '../components/AnimatedH1'  // Changed this line

export default function Home() {
  const [showLanguagesModal, setShowLanguagesModal] = useState(false)

  // Complete list of languages for the modal
  const allLanguages = [
    // UN Official Languages
    'Arabic', 'Chinese', 'English', 'French', 'Russian', 'Spanish',
    
    // European Languages
    'Albanian', 'Armenian', 'Azerbaijani', 'Basque', 'Belarusian', 'Bosnian', 'Bulgarian', 'Catalan', 'Croatian', 'Czech', 'Danish', 'Dutch', 'Estonian', 'Finnish', 'Galician', 'Georgian', 'German', 'Greek', 'Hungarian', 'Icelandic', 'Irish', 'Italian', 'Latvian', 'Lithuanian', 'Luxembourgish', 'Macedonian', 'Maltese', 'Moldovan', 'Montenegrin', 'Norwegian', 'Polish', 'Portuguese', 'Romanian', 'Serbian', 'Slovak', 'Slovenian', 'Swedish', 'Turkish', 'Ukrainian', 'Welsh',
    ...
    'Abkhaz', 'Avar', 'Bashkir', 'Chechen', 'Chuvash', 'Kazakh', 'Kyrgyz', 'Ossetian', 'Tajik', 'Tatar', 'Turkmen', 'Uzbek',
    
    // ASEAN Languages
    'Bahasa Indonesia', 'Bahasa Malaysia', 'Burmese', 'Khmer', 'Lao', 'Tagalog', 'Thai', 'Vietnamese',
    
    // Top African Languages
    'Afrikaans', 'Amharic', 'Hausa', 'Igbo', 'Oromo', 'Shona', 'Somali', 'Swahili', 'Xhosa', 'Yoruba', 'Zulu',
    
    // Additional Major Languages
    'Albanian', 'Hebrew', 'Japanese', 'Korean', 'Mandarin', 'Persian', 'Sinhala'
  ].sort() // Alphabetical sorting

  const openModal = () => setShowLanguagesModal(true)
  const closeModal = () => setShowLanguagesModal(false)

  // Split languages into 4 columns
